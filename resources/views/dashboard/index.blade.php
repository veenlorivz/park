...
@section('content')
        ...
        <div class="row mb-2">
            <div class="col-lg-4">
                <form class="input-group mb-3 shadow" method="POST" action="/dashboard/parkir/search">
                    @csrf
                    @method("POST")
                    <input type="text" class="form-control" placeholder="Cari No Plat" aria-label="Recipient's username" aria-describedby="basic-addon2" name="search">
                ...
                <div class="col-lg-4 col-md-6 mb-3">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-title mb-3">Waktu Masuk : {{ date("F j, Y, g:i a", strtotime($k->created_at)) }}</p>
                            <button data-bs-toggle="modal" data-bs-target="#modalSelesai" class="btn btn-success" onclick="getDataModal( {{ $k }})">Selesai</button>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="modal-body">
                            <div class="mb-2 row">
                                ...
                                <div class="col-sm-8 d-flex flex-row align-items-center">
                                  :&nbsp; <input type="text" readonly class="form-control-plaintext" id="no_plat" name="no_plat">
                                </div>
                            </div>
                            <div class="mb-2 row">
                                <label for="staticEmail" class="col-sm-4 col-form-label">Merek kendaraan</label>
                                <div class="col-sm-8 d-flex flex-row align-items-center">
                                  :&nbsp; <input type="text" readonly class="form-control-plaintext" id="merk" name="merk_kendaraan">
                                </div>
                            </div>
                            <div class="mb-2 row">
                                <label for="staticEmail" class="col-sm-4 col-form-label">Waktu Masuk</label>
                                <div class="col-sm-8 d-flex flex-row align-items-center">
                                  :&nbsp; <input type="text" readonly class="form-control-plaintext" id="masuk" name="waktu_masuk">
                                </div>
                            </div>
                            <div class="mb-2 row">
                                <label for="staticEmail" class="col-sm-4 col-form-label">Waktu Keluar</label>
                                <div class="col-sm-8 d-flex flex-row align-items-center">
                                  :&nbsp; <input type="datetime" readonly class="form-control-plaintext" id="keluar" name="waktu_keluar">
                                </div>
                            </div>
                            <div class="mb-2 row">
                                <label for="staticEmail" class="col-sm-4 col-form-label">Harga Per jam</label>
                                <div class="col-sm-8 d-flex flex-row align-items-center">
                                  :&nbsp; <input type="text" readonly class="form-control-plaintext" value="2000" name="harga">
                                </div>
                            </div>
                            <div class="mb-2 row">
                                <label for="staticEmail" class="col-sm-4 col-form-label">Total Waktu</label>
                                <div class="col-sm-8 d-flex flex-row align-items-center">
                                  :&nbsp; <input type="text" readonly class="form-control-plaintext" id="total_waktu" name="total_waktu">
                                </div>
                            </div>
                            <div class="mb-2 row">
                                <label for="staticEmail" class="col-sm-4 col-form-label">Total Harga</label>
                                <div class="col-sm-8 d-flex flex-row align-items-center">
                                  :&nbsp; <input type="text" readonly class="form-control-plaintext" id="total_harga" name="total_harga">
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        const getDataModal = (data) => {
            ...
            const total_harga = intToRupiah(getTotalHarga(new Date(data.created_at.split(".")[0].split("T").join(",")), new Date()))
            ...
            document.querySelector("#keluar").value = `${tanggal_keluar[2]}-${tanggal_keluar[1]}-${tanggal_keluar[0]}, ${waktu_keluar}`
